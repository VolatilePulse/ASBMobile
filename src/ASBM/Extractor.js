...
/*       this.c.m = multipliers;
      this.c.values = values;
      this.c.level = level;
      this.c.wild = isWild;
      this.c.tamed = isTamed;
      this.c.bred = isBred;
      this.c.exactly = exactly; */
   ...
   extract() {
      ...
      torporStat.calculateWildLevel(this.c.m[TORPOR], this.c.values[TORPOR], (!this.c.wild), this.c.TE, this.IB);
      ...
      if (this.c.bred && !this.c.exactly &&
            this.c.values[TORPOR] != Utils.RoundTo(tempStat.calculateValue(this.c.m[TORPOR], !this.c.wild, this.c.TE, this.c.IB), Utils.Precision(TORPOR))) {
         ...
         if (this.c.values[TORPOR] == Utils.RoundTo(tempStat.calculateValue(this.c.m[TORPOR], !this.c.wild, this.c.TE, imprintingBonusFromFood), Utils.Precision(TORPOR)))
      ...
      if (this.c.wild) {
         for (let i = 0; i < 7; i ++) {
            ...
            if (this.c.values[i] == Utils.RoundTo(tempStat.calculateValue(this.c.m[i]), Ark.Precision(i)))
               this.c.stats[i].push(new ASBM.Stat(tempStat));
         }
         return;
      }
      ...
      for (var i = 0; i < 7; i ++) {
         ...
         if (this.c.m[i].notUsed) {
            ...
            this.c.stats[i] = [new ASBM.Stat(-1, 0)];
            continue;
         }
         ...
         // We can't calculate speed if a stat is unused
            ...
            this.c.stats[SPEED] = [new ASBM.Stat(-1, tempStat.calculateDomLevel(this.c.m[i], this.c.values[i], !this.c.wild, 0, this.c.IB))];
